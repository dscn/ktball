...
-keep public class com.swarm.ui.load.LoadProgress
-keep public class com.swarm.activity.**
-keep public class com.swarm.model.**
-keep public class com.swarm.model.UpdateApp
...
#优酷
-libraryjars ..\\YoukuPlayerOpenSDK
-keep class com.youku.{*;}
-keep class org.openudid.{*;}
-keep class com.v7.widget.{*;}
