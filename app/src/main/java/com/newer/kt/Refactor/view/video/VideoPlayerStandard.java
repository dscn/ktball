...
public class VideoPlayerStandard extends VideoPlayer {
    ...
    public TextView tv_mvname;
    public TextView tv_mvdate;
    private ImageView thumbImageView;
    protected static Timer DISSMISS_CONTROL_VIEW_TIMER;
    protected DismissControlViewTimerTask mDismissControlViewTimerTask;

    protected static VideoBuriedPointStandard JC_BURIED_POINT_STANDARD;
    ...
    protected void init(Context context) {
        ...
        tv_mvname = (TextView) findViewById(R.id.tv_mvname);
        tv_mvdate = (TextView) findViewById(R.id.tv_mvdate);
    ...
    public static void setJcBuriedPointStandard(VideoBuriedPointStandard jcBuriedPointStandard) {
        JC_BURIED_POINT_STANDARD = jcBuriedPointStandard;
        VideoPlayer.setJcBuriedPoint(jcBuriedPointStandard);
    }
