 ...
 * On 2015/11/30 15:39
 */
public class VideoMediaManager implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnCompletionListener,
        IMediaPlayer.OnBufferingUpdateListener, IMediaPlayer.OnSeekCompleteListener, IMediaPlayer.OnErrorListener,
        IMediaPlayer.OnVideoSizeChangedListener, IMediaPlayer.OnInfoListener {
    public static String TAG = VideoPlayer.TAG;

    public IjkMediaPlayer mediaPlayer;
    private static VideoMediaManager JCMediaManager;
    ...
    public static VideoMediaManager instance() {
        if (JCMediaManager == null) {
            JCMediaManager = new VideoMediaManager();
        }
...
//              mediaPlayer.setDataSource(context, Uri.parse(url), mapHeadData);
                        ...
                        mediaPlayer.setOnPreparedListener(VideoMediaManager.this);
                        mediaPlayer.setOnCompletionListener(VideoMediaManager.this);
                        mediaPlayer.setOnBufferingUpdateListener(VideoMediaManager.this);
                        mediaPlayer.setScreenOnWhilePlaying(true);
                        mediaPlayer.setOnSeekCompleteListener(VideoMediaManager.this);
                        mediaPlayer.setOnErrorListener(VideoMediaManager.this);
                        mediaPlayer.setOnInfoListener(VideoMediaManager.this);
                        mediaPlayer.setOnVideoSizeChangedListener(VideoMediaManager.this);
