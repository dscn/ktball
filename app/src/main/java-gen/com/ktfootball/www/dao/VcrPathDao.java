...
/** 
 * DAO for table VCR_PATH.
*/
public class VcrPathDao extends AbstractDao<VcrPath, Long> {

    public static final String TABLENAME = "VCR_PATH";

    /**
     * Properties of entity VcrPath.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property IsSuccess = new Property(22, Boolean.class, "isSuccess", false, "IS_SUCCESS");
    };


    public VcrPathDao(DaoConfig config) {
        super(config);
    }
    
    public VcrPathDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'VCR_PATH' (" + //
                ...
                "'IS_SUCCESS' INTEGER);"); // 22: isSuccess
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'VCR_PATH'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, VcrPath entity) {
        stmt.clearBindings();
        ...
        if (isSuccess != null) {
            stmt.bindLong(23, isSuccess ? 1l: 0l);
        }
    }
    ...
    /** @inheritdoc */
    @Override
    public VcrPath readEntity(Cursor cursor, int offset) {
        VcrPath entity = new VcrPath( //
            ...
            cursor.isNull(offset + 22) ? null : cursor.getShort(offset + 22) != 0 // isSuccess
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, VcrPath entity, int offset) {
        ...
        entity.setIsSuccess(cursor.isNull(offset + 22) ? null : cursor.getShort(offset + 22) != 0);
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(VcrPath entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(VcrPath entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
