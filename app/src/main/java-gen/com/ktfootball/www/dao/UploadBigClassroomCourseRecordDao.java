...
/** 
 * DAO for table UPLOAD_BIG_CLASSROOM_COURSE_RECORD.
*/
public class UploadBigClassroomCourseRecordDao extends AbstractDao<UploadBigClassroomCourseRecord, Long> {

    public static final String TABLENAME = "UPLOAD_BIG_CLASSROOM_COURSE_RECORD";

    /**
     * Properties of entity UploadBigClassroomCourseRecord.<br/>
    ...
    */
    ...
    public UploadBigClassroomCourseRecordDao(DaoConfig config) {
        super(config);
    }
    
    public UploadBigClassroomCourseRecordDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'UPLOAD_BIG_CLASSROOM_COURSE_RECORD' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'UPLOAD_BIG_CLASSROOM_COURSE_RECORD'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, UploadBigClassroomCourseRecord entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public UploadBigClassroomCourseRecord readEntity(Cursor cursor, int offset) {
        UploadBigClassroomCourseRecord entity = new UploadBigClassroomCourseRecord( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, UploadBigClassroomCourseRecord entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(UploadBigClassroomCourseRecord entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(UploadBigClassroomCourseRecord entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
