...
/** 
 * DAO for table RANKING_LEAGUE_SCORES.
*/
public class RankingLeagueScoresDao extends AbstractDao<RankingLeagueScores, Long> {

    public static final String TABLENAME = "RANKING_LEAGUE_SCORES";

    /**
     * Properties of entity RankingLeagueScores.<br/>
    ...
    */
    ...
    public RankingLeagueScoresDao(DaoConfig config) {
        super(config);
    }
    
    public RankingLeagueScoresDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'RANKING_LEAGUE_SCORES' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'RANKING_LEAGUE_SCORES'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, RankingLeagueScores entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public RankingLeagueScores readEntity(Cursor cursor, int offset) {
        RankingLeagueScores entity = new RankingLeagueScores( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, RankingLeagueScores entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(RankingLeagueScores entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(RankingLeagueScores entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
