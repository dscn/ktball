...
public class ToolBarHelper {
    ...
    * */
    ...
    private void initToolBar() {
        ...
        title = (TextView) toolbar.findViewById(R.id.layout_title_tv);
        mToolBar = (Toolbar) toolbar.findViewById(R.id.toolbar);
        iv_right = (TextView) toolbar.findViewById(R.id.layout_title_iv);
        icon_right = (ImageView) toolbar.findViewById(R.id.layout_title_icon);
    }
